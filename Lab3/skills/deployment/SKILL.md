...
6. Capture the exact output to `artifacts/docs/deploy_log.txt`.
7. Capture the deployed endpoint URI or status into `artifacts/docs/deploy_report.md`.


## Output
Produce `artifacts/docs/deploy_log.txt` with raw stdout/stderr, and `artifacts/docs/deploy_report.md` summarizing the deployment.
